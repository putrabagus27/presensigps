<aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand">
            <img src="{{ asset('assets/img/login/login.jpg') }}" style="border-radius: 40%" width="50" height="60" alt="Bali Summer Manufacture" class="navbar">
            <span style="margin-left: 10px;">Bali Summer <br>
                Manufacture</span>
        </h1>
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="/gaji">
                                    Data Gaji Pegawai
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/presensi/izinsakit">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-checklist" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/proseslogoutadmin">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
